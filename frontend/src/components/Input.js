...
export default function Input({ icon: Icon, style, showPasswordToggle, secureTextEntry, ...props }) {
  ...
  return (
    <View style={[styles.container, isFocused && styles.focused, style]}>
      {Icon && <Icon size={18} color={isFocused ? '#E2E8F0' : '#94A3B8'} style={styles.icon} />}
      <TextInput
        style={styles.input}
